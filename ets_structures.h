...
void create_loans(struct ets_item *item, char *borrowerId,
	       	char *borroweeId, unsigned quantity);
void create_item(struct ets_item *item, char *itemId,
	       	char *name, unsigned quantity);
...
BOOLEAN item_borrowed(struct ets * ets, char * itemId,
	       	unsigned quantity);
void print_member(struct ets * ets, char *memberId);
void display_member_info(struct ets * ets, char *id);
void add_to_existing_loan(struct ets * ets, char *memberId,
	       	char *itemId, unsigned amount);
