...
HEADERS = *.h
USER = s3453738
ARCHIVE_FILES = *.c *.h Makefile README.md readme.txt
EXE = ets
...
archive:
	...
	ets_menu.c ets_menu.h ets_utility.h ets_utility.c ets_structures.h ets_structures.c Makefile README.md readme.txt
